...
//   NODE_USE_ENV_PROXY=1 node derogue/social/render.mjs
...
await page.goto("http://localhost:8765/derogue/social/templates.html", { waitUntil: "networkidle" });
...
for (const id of await page.$$eval(".card", els => els.map(e => e.id))) {
  await page.locator("#" + id).screenshot({ path: `derogue/social/${id}.png` });
